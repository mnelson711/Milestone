  ...
  return (
    <ScreenContainer>
      ...
      <SectionCard>
        ...
        <View style={styles.listItem}>
          <AppText variant="body">• View upcoming milestones for each event</AppText>
        </View>
        <View style={styles.listItem}>
          <AppText variant="body">• Enable local milestone notifications</AppText>
        </View>
        <View style={styles.listItem}>
          <AppText variant="body">• Customize default milestone settings</AppText>
        </View>
      </SectionCard>
      ...
      <SectionCard>
        ...
        />
        <AppText variant="body" style={styles.bodyText}>
          The idea behind Milestone is to make meaningful dates feel more playful,
          personal, and memorable by highlighting time in a different way.
        </AppText>
      </SectionCard>
    </ScreenContainer>
  );
